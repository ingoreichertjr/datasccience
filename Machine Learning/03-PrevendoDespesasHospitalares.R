...
boxplot(despesas$gastos, main = 'Gastos Hospitalares')
...
# ou 
modelo <- lm(gastos ~ ., data = despesas) # o "." substitui todas as variáveis
...
despesas_teste <- read_csv('despesas-teste.csv')
View(despesas_teste)
previsao <- predict(modelo, despesas_teste)
class(previsao)
View(previsao)