...
# Aplicando mutate
glimpse(mutate(sono_df, peso_libras = sono_total / 0.4535923))
# Criado uma nova coluna apenas para visualização, mas ela ainda não faz parte da tabela
